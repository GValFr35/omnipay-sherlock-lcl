...
use Omnipay\Sherlock\OffsiteGateway;
...
{
  /**
   * @var Omnipay/Sherlock/SystemGateway
   */
    public $gateway;
    ...
    public function testPurchase()
    {
        ...
        $this->assertInstanceOf('Omnipay\Sherlock\Message\OffsiteAuthorizeResponse', $response);
        $this->assertFalse($response->isSuccessful());
        $this->assertTrue($response->isRedirect());
        $this->assertNotEmpty($response->getRedirectUrl());
        $this->assertSame('https://sherlocks-payment-webinit-simu.secure.lcl.fr/paymentInit', $response->getRedirectUrl());
    ...
    public function testOffsiteNotify()
    {
        ...
        $this->assertInstanceOf('Omnipay\Sherlock\Message\OffsiteNotifyRequest', $request);
    }
    ...
    public function testCompletePurchase()
    {
        ...
        $this->assertInstanceOf('Omnipay\Sherlock\Message\OffsiteCompletePurchaseRequest', $request);
